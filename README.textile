...
h2. First: Import the JavaScript and CSS plugin files into your HTML code.
...
h2. Second: write the code for the select/option
...
h2. Third: you need to call the jQuery connect_ll() function on a selector
